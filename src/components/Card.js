  ...
  return (
    <div className="mt-5">
      ...
      {showData === true ? (
          ...
          <div className="card mb-3 mx-auto bg-dark text-light">
            <div className="row g-0">
              <div className="col-md-4">
                ...
                <img
                  src="https://images.pexels.com/photos/10549877/pexels-photo-10549877.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
        ...
        <div>
          <h2 style={{ color: "rgb(55, 55, 55)" }}>
            {" "}
            NO HAY DATOS PARA MOSTRAR<br></br>
            INGRESA TU CIUDAD
          </h2>
        </div>
      )}
